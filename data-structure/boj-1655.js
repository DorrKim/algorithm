...
function solution(numbers) {
  ...
  numbers.forEach((number, index) => {
    ...
    while (maxHeap.peekRoot() !== null && minHeap.peekRoot() !== null && maxHeap.peekRoot() > minHeap.peekRoot()) {
      const maxHeapRoot = maxHeap.pop();
      const minHeapRoot = minHeap.pop();

      maxHeap.add(minHeapRoot);
      minHeap.add(maxHeapRoot);
    }
    result += `${maxHeap.peekRoot()}\n`;
  });
